...
void SceneSkyPlane::RenderText(Mesh* mesh, std::string text, Color color)
{
...
void SceneSkyPlane::RenderTextOnScreen(Mesh* mesh, std::string text, Color color, float size, float x, float y)
{
	if(!mesh || mesh->textureID <= 0)
		return;
...
void SceneSkyPlane::RenderMesh(Mesh *mesh, bool enableLight)
{
...
void SceneSkyPlane::RenderSkybox()
{
	//left
	modelStack.PushMatrix();
...
void SceneSkyPlane::RenderMeshIn2D(Mesh *mesh, bool enableLight, float size, float x, float y)
{
	Mtx44 ortho;
...
void SceneSkyPlane::RenderSkyPlane()
{
	modelStack.PushMatrix();
