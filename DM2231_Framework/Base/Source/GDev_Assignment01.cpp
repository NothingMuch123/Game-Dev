...
void GDev_Assignment01::RenderText(Mesh* mesh, std::string text, Color color)
{
...
void GDev_Assignment01::RenderTextOnScreen(Mesh* mesh, std::string text, Color color, float size, float x, float y)
{
	if(!mesh || mesh->textureID <= 0)
		return;
...
void GDev_Assignment01::RenderMesh(Mesh *mesh, bool enableLight)
{
...
void GDev_Assignment01::RenderMeshIn2D(Mesh *mesh, bool enableLight, float size, float x, float y)
{
	Mtx44 ortho;
